...
const TaskCompletion5: React.FC = () => {
  const history =useHistory();
  const [coinBalance, setCoinBalance] = useState<number>(25); // Initialize coin balance
  ...
  const handleNewTaskClick = () => {
    ...
    setCoinBalance((prevBalance) => prevBalance + 5);
...
{ /* New Task */}
    <div
        ...
        style={{
          ...
          height: '138px', // Set the height to 250px
          zIndex: 10, // Ensure the egg is above the background
          visibility: 'visible',
          opacity: 1,
        }}
...
export default TaskCompletion5;