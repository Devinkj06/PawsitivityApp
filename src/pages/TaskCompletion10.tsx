...
import reward10 from '../assets/images/reward10.png';

const TaskCompletion10: React.FC = () => {
  ...
  const handleNewTaskClick = () => {
    ...
    setCoinBalance((prevBalance) => prevBalance + 10);
  };
...
export default TaskCompletion10;